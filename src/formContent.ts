 ...
 * You can edit all questions, option labels, descriptions, and button texts here.
 */
...
export type SupportedLanguage = 'en' | 'vn' | 'ru';
...
export const FORM_CONTENT_CONFIG: Record<SupportedLanguage, FormTextConfig> = {
  ...
  en: {
    ...
    contact: {
      ...
      emailHint: 'We will send details to this address and incubator management',
  ...
  vn: {
    ...
    contact: {
      ...
      emailPlaceholder: 'name@example.com',
      emailHint: 'Thông tin xác nhận sẽ được gửi đến email này và ban quản trị',
  ...
  ru: {
    ...
    contact: {
      ...
      emailPlaceholder: 'name@example.com',
      emailHint: 'Копия заявки будет отправлена на этот адрес и руководству',
    ...
    success: {
      ...
      deliveredEmail: 'Копия отправлена руководству инкубатора',
